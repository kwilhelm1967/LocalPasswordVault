          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 mb-6 flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm">
                Create a strong master password to secure your vault. This
                password will be required each time you access your passwords.
              </p>
            </div>
          </div>
        )}
            ...
            <div>
              ...
              {isFirstTime && (
                <p className="text-xs text-slate-400 mt-2">
                  Minimum 6 characters. Use a strong, unique password you'll
                  remember.
                </p>
              )}
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  All data is encrypted locally on your device. Your passwords
