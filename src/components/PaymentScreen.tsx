...
export const PaymentScreen: React.FC<PaymentScreenProps> = ({
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 overflow-y-auto"
      ...
      {!paymentSuccess ? (
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center pt-4">
            <p className="text-xs text-slate-400">
              Your payment is secure. We use Stripe for secure payment
              processing.
            </p>
          </div>
        </form>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-700/50 border border-slate-600 rounded-lg p-4">
            ...
            <div className="bg-slate-800 p-3 rounded  text-blue-400 text-center select-all">
              {licenseKey}
            </div>
