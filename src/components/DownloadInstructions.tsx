        ...
        <div className="p-6 overflow-y-auto flex-1">
          <div className="space-y-6">
            <div className="bg-blue-900/20 border border-blue-800/30 rounded-lg p-4">
              ...
              <div className="bg-slate-800 p-3 rounded  text-blue-400 text-sm select-all">
                {licenseKey}
              </div>
            ...
            <div className="bg-slate-700/50 rounded-lg p-4">
              ...
              <ol className="space-y-2 text-slate-300 text-sm">
                ...
                <li>
                  2. Download each file individually by right-clicking and
                  selecting "Save As"
                </li>
                <li>
            ...
            <div className="bg-slate-700/50 rounded-lg p-4">
              ...
              <div className="bg-slate-800 p-3 rounded  text-sm text-slate-300 overflow-x-auto">
                <pre>
...
npm run dev`}
        ...
        <div className="p-6 border-t border-slate-700 bg-slate-800/80">
          <div className="flex justify-end">
            ...
            >
              Continue to Local Password Vault
            </button>
          </div>
        </div>
      </div>
